    ...
    <body>
        ...
        <div id="contenu">
            <div id="content-container-two-column">
                <div id="content-side-one-column">
                    <h2>
                        <center><u>Actualités</u></center>
                    </h2>
					...
					<div id="dl-menu" class="dl-menuwrapper">
						...
						<ul class="dl-menu">
							<li>
								...
								<ul class="dl-submenu">
									<li>
										<a id="modal_trigger" href="#modal">Je me connecte</a>										
									</li>									
								</ul>
							</li>
							<li>
								<a href="#">Non-adherent</a>
								<ul class="dl-submenu">
									<li>
										<a id="modal_triggers" href="#modal">Bulletin d'adhesion</a>									
									</li>
								</ul>
							</li>
							<li>
