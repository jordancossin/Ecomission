...
class PdoGsb{
      	...
      	private static $bdd='dbname=ecomission';
...
*/
	public function getInfosVisiteur($login, $mdp){
		$req = "select adherents.id as id, adherents.nom as nom, adherents.prenom as prenom from adherents
		where adherents.identifiant=:identifiant and adherents.mdp=:mdp";
		$query = PdoGsb::$monPdo->prepare($req);
		$query->execute(array(':identifiant' => $login, ':mdp' => $mdp));
		$ligne = $query->fetch();
		return $ligne;
	}
